...
import torch
import re
from model.bilstm_attention import BiLSTMAttentionTagger


class BiLSTMAttentionInference:
    def __init__(self, 
                 config_path, vocab_path, model_path):
        # Load config
        ...
        # Load model
        self.model = BiLSTMAttentionTagger(
